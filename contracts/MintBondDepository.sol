...
contract MintBondDepository is Ownable {
    ...
    function deposit( 
        ...
        uint balanceBefore = MINT.balanceOf(address(this));
        /**
            principle is transferred in
            approved and
            deposited into the treasury, returning (_amount - profit) MINT
         */
        ...
        if ( fee != 0 ) { // fee is transferred to dao 
            MINT.safeTransfer( DAO, fee ); 
        }
        require(balanceBefore.add(profit) == MINT.balanceOf(address(this)), "Not enough MINT to cover profit");
